                        ...
                        <div class="dropdown">
                            ...
                            <div class="cart-dropdown"
                                ...
                                <div>
                                    ...
                                    <div>
                                        <a href="/logout" class="btn btn-primary" style="" onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">Đăng xuất</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <c:forEach var="diaChi" items="${diaChiList}">
            ...
            <div class="address-container">
                <div class="address-details">
                    <p style="font-weight: bold; font-size: 15px">${kh.hoTen} | ${kh.soDienThoai}</p>
                    <p>${diaChi.soDiaChi}, ${diaChi.phuong}, ${diaChi.quan}, ${diaChi.thanhPho}</p>
                </div>
                <div class="buttons">
            ...
            <div class="modal-body">
                <form:form action="/add-dia-chi-kh" method="post" modelAttribute="diaChiKH">
                    <table class="table" style="height: 100%">
                        <tr>
                            <th>
                                <form:label class="form-label" path="soDiaChi">Địa chỉ:
                                    <form:errors path="soDiaChi" cssStyle="color: red"></form:errors>
                                </form:label>
                                <form:input id="tenhkh" class="form-control" placeholder="" path="soDiaChi" value=""/>
                            </th>
                            <th>
                            ...
                            <th style="display: none">
                                <form:label class="form-label" path="phuong">Huyện: <form:errors path="phuong" cssStyle="color: red"></form:errors>
                                </form:label>
                                <form:input id="huyen" class="form-control" placeholder=""  path="phuong" />
                            </th>
                        </tr>
                        <tr>
            ...
            <div class="modal-body">
                <form:form action="/update-dia-chi-kh" method="post" modelAttribute="diaChiKHupdate">
                    <div style="display: none">
                        ...
                        <form:input  class="form-control" placeholder="" path="trangThai" value=""/>
                    ...
                    <table class="table" style="height: 100%">
                        <tr>
                            <th>
                                ...
                                <form:input  class="form-control" placeholder="" path="soDiaChi" value=""/>
                            </th>
                            <th>
                                <form:label class="form-label" path="quan">Quận/Huyện:
                                    <form:errors path="quan" cssStyle="color: red"></form:errors></form:label>
                            ...
                            <th style="display: none" >
                                ...
                                <form:input id="huyen1" class="form-control" placeholder=""  path="phuong" />
                            </th>
                        </tr>
                        <tr>
                            <th>  <form:label class="form-label" path="thanhPho">Thành Phố: <form:errors path="thanhPho" cssStyle="color: red"></form:errors>
