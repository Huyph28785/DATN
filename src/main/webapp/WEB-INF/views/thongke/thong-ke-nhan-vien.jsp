                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-pills mb-3" id="setting-panel" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="description-tab" data-toggle="tab" href="/thong-ke/hien-thi-nhan-vien" role="tab"
                                <%--                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;"--%>
                                   aria-controls="description" aria-selected="false" >Doanh thu theo nhân viên</a>
                            </li>
                        </ul>
